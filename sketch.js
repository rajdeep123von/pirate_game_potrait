...
function setup() {
  ...
  skys1 = createSprite(56,height-550,400,20);
  skys1.addImage("ground",sky);  
  skys1.scale = 1;
  skygroup.add(skys1);

  skys2 = createSprite(skys1.x+112,height-550,400,20);
  skys2.addImage("ground",sky);  
  skys2.scale = 1;
  skygroup.add(skys2);

  skys3 = createSprite(skys2.x+112,height-550,400,20);
  skys3.addImage("ground",sky);  
  skys3.scale = 1;
  skygroup.add(skys3);

  skys4 = createSprite(skys3.x+112,height-550,400,20);
  skys4.addImage("ground",sky);  
  skys4.scale = 1;
  skygroup.add(skys4);

  skys5 = createSprite(skys4.x+112,height-550,400,20);
  skys5.addImage("ground",sky);  
  skys5.scale = 1;
  skygroup.add(skys5);

  skys6 = createSprite(skys5.x+112,height-550,400,20);
  skys6.addImage("ground",sky);  
  skys6.scale = 1;
  skygroup.add(skys6);

  skys7 = createSprite(skys6.x+112,height-550,400,20);
  skys7.addImage("ground",sky);  
  skys7.scale = 1;
  skygroup.add(skys7);

  skys8 = createSprite(skys7.x+112,height-550,400,20);
  skys8.addImage("ground",sky);  
  skys8.scale = 1;
  skygroup.add(skys8);

  skys9 = createSprite(skys8.x+112,height-550,400,20);
  skys9.addImage("ground",sky);  
  skys9.scale = 1;
  skygroup.add(skys9);

  skys10= createSprite(skys9.x+112,height-550,400,20);
  skys10.addImage("ground",sky);  
  skys10.scale = 1;
  skygroup.add(skys10);

  skys11 = createSprite(skys10.x+112,height-550,400,20);
  skys11.addImage("ground",sky);  
  skys11.scale = 1;
  skygroup.add(skys11);

  skys12 = createSprite(skys11.x+112,height-550,400,20);
  skys12.addImage("ground",sky);  
  skys12.scale = 1;
  skygroup.add(skys12);

  sea3 = createSprite(896/2,height+100,400,20);
  sea3.addImage("ground",groundImage); 
  sea3.velocityX = -7
  sea3.scale = 8;

  sea2 = createSprite(sea3.x+896,height+100,400,20);
  sea2.addImage("sea",groundImage);
  sea2.velocityX = -7;
  sea2.scale = 8;

  sea1 = createSprite(sea2.x+896,height+100,400,20);
  sea1.addImage("sea2",groundImage);
  sea1.velocityX = -7;
  sea1.scale = 8;

  clouds1 = createSprite(270,height-400,400,20);
  clouds1.addImage("clouds",clouds);
  cloudGroup.add(clouds1);

  clouds2 = createSprite(clouds1.x+clouds1.width,height-400,400,20);
  clouds2.addImage("clouds",clouds);
  cloudGroup.add(clouds2);

  
  clouds3 = createSprite(clouds2.x+clouds2.width,height-400,400,20);
  clouds3.addImage("clouds",clouds);
  cloudGroup.add(clouds3);

  
  farg = createSprite(1300,height-310,400,20);
  ...
  ship = createSprite(500,height-400);
  ...
  land0 = createSprite(1570,height-50);
  ...
  land9 = createSprite(1440,height-50);
  ...
  land8 = createSprite(1310,height-50);
  ...
  land7 = createSprite(1180,height-50);
  ...
  land6 = createSprite(1050,height-50);
  ...
  land5 = createSprite(790+130,height-50);
  ...
  land4 = createSprite(790,height-50);
  ...
  land3 = createSprite(660,height-50);
  ...
  land2 = createSprite(530,height-50);
  ...
  land1 = createSprite(400,height-50);
...
if(gameState === PLAY){
    ...
    if(birdsGroup.isTouching(plr)|| plr.y>height ||plr.x<0||objGroup.isTouching(plr)){
     // plr.destroy();
      plr.visible = false;
...
//console.log(windowHeight);
  ...
  textFont("Chiller");
  fill(254, 147, 36);
  text("Score: "+ score, width-150,height-630);
...
function spawntiles() {
  ...
  if (frameCount% 79 === 0 ) {
    var tiles = createSprite(width+100,height-310,40,10);
   
    tiles.y = Math.round(random(height-370,height-100));
    tiles.addImage("tile",tile);
    tiles.scale = 2.5;
    tiles.setCollider("rectangle",0,0,60,37,0);   
    tiles.velocityX = -7;

    var tiles1 =  createSprite(width+200,tiles.y,40,10);
    tiles1.addImage("tile",tile);
    tiles1.scale = 2.5;
    tiles1.setCollider("rectangle",0,0,60,37,0);
  tiles1.velocityX = -7;

    var tiles2 =  createSprite(width+300,tiles.y,40,10);
    tiles2.addImage("tile",tile);
    tiles2.scale = 2.5;
    tiles2.setCollider("rectangle",0,0,60,37,0);
   tiles2.velocityX = -7;

   var tiles3 =  createSprite(width+400,tiles.y,40,10);
  ...
  if(frameCount% 316=== 0 && score>400){
    var spike = createSprite(width+200,tiles.y-30,20,20);
  ...
  function spawnbirds(){
    if(frameCount% 156=== 0){
      var bird = createSprite(width+100,height-600,20,20);
      bird.addAnimation("flying",bird_img);
      bird.y = Math.round(random(height-600,height-300));
      bird.velocityX = -8;
      bird.scale=0.8;
